...
public class TestService {
	...
	public Plat getPlatTest() throws SQLException
	{
		...
		testPlat.setId(1);
		testPlat.setDescription("Asperiores jambon atdi nesciunt quas voluptat jambon atdi nesciunt quas voluptat jambon atdi nesciunt quas voluptat jambon atdi nesciunt quas voluptatum?");
